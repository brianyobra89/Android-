...
public class ActivityThree extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText("Lost and found page and their drop downs");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_home:
                        Intent a = new Intent(ActivityThree.this, MainActivity.class);
                        startActivity(a);

                        break;
                    case R.id.navigation_dashboard:
                        Intent b = new Intent(ActivityThree.this, ActivityOne.class);
                        startActivity(b);

                        break;
                    case R.id.navigation_notifications:
                        Intent c = new Intent(ActivityThree.this, ActivityTwo.class);
                        startActivity(c);
                        break;
                    ...
                    case R.id.navigation_me:
                        Intent e = new Intent(ActivityThree.this,ActivityFour.class);
                        startActivity(e);
                        break;
